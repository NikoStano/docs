...
<Card
  ...
  icon="github"
  href="https://github.com/NikoStano/push_swap"
>
...
<AccordionGroup>
  ...
  <Accordion title="rr (rotate both)">
    Faire `ra` et `rb` en même temps
  </Accordion>
  
  <Accordion title="rra (reverse rotate a)">
  ...
  <Accordion title="rrb (reverse rotate b)">
  ...
  <Accordion title="rrr (reverse rotate both)">
...
<AccordionGroup>
  ...
  <Accordion title="Dépassement d'INT">
  ...
  <Accordion title="Mauvais calcul de coût">
...
<AccordionGroup>
  ...
  <Accordion title="Optimisation des rotations doubles">
  ...
  <Accordion title="Meilleure sélection de chunks">
  ...
  <Accordion title="Algorithme A* ou Greedy amélioré">
...
<CardGroup cols={2}>
  <Card title="Visualiseur" icon="eye" href="https://github.com/o-reo/push_swap_visualizer">
    Voir les mouvements en temps réel
  </Card>
  
  <Card title="Tester" icon="vial" href="https://github.com/LeoFu9487/push_swap_tester">
    Testeur automatique complet
  </Card>
  
  <Card title="Algorithme Turk" icon="book" href="https://medium.com/@ayogun/push-swap-c1f5d2d41e97">
    Explication détaillée de l'algorithme
  </Card>
  
  <Card title="Listes chaînées" icon="link" href="https://www.learn-c.org/en/Linked_lists">
