...
<Card
  ...
  icon="github"
  href="https://github.com/NikoStano/FdF"
>
...
<Steps>
  <Step title="Graphisme en C">
    Apprendre à utiliser la MiniLibX pour afficher des pixels et des lignes
  </Step>
  
  <Step title="Mathématiques 3D">
    Comprendre les transformations matricielles et les projections
  </Step>
  
  <Step title="Parsing de fichiers">
    Lire et interpréter des fichiers de carte (format .fdf)
  </Step>
  
  <Step title="Optimisation">
    Gérer l'affichage fluide de grandes cartes
  </Step>
</Steps>
...
<Tabs>
  ...
  <Tab title="Extraction des valeurs">
    ```c
...
<AccordionGroup>
  ...
  <Accordion title="Projection parallèle">
  ...
  <Accordion title="Gradient de couleurs">
...
<AccordionGroup>
  ...
  <Accordion title="Carte centrée incorrectement">
  ...
  <Accordion title="Segfault lors du parsing">
  ...
  <Accordion title="Fuites mémoire">
...
<CardGroup cols={2}>
  <Card title="MiniLibX Docs" icon="book" href="https://harm-smits.github.io/42docs/libs/minilibx">
    Documentation complète de la MiniLibX
  </Card>
  
  <Card title="Bresenham Algorithm" icon="chart-line" href="https://en.wikipedia.org/wiki/Bresenham%27s_line_algorithm">
    Comprendre l'algorithme de Bresenham
  </Card>
  
  <Card title="Isometric Projection" icon="cube" href="https://en.wikipedia.org/wiki/Isometric_projection">
    Projection isométrique expliquée
  </Card>
  
  <Card title="3D Rotations" icon="rotate" href="https://en.wikipedia.org/wiki/Rotation_matrix">
