...
<AccordionGroup>
  ...
  <Accordion title="%s - Chaîne de caractères">
  ...
  <Accordion title="%d et %i - Entier décimal">
  ...
  <Accordion title="%u - Entier non signé">
  ...
  <Accordion title="%x et %X - Hexadécimal">
...
<Accordion title="Comment fonctionnent les fonctions variadiques ?">
...
<AccordionGroup>
  ...
  <Accordion title="NULL pointeurs">
    ```c
...
<AccordionGroup>
  ...
  <Accordion title="Mauvais comptage">
    ```c
    // ❌ Mauvais
  ...
  <Accordion title="Type incorrect dans va_arg">
    ```c
    // ❌ Mauvais
  ...
  <Accordion title="INT_MIN mal géré">
    ```c
    // ❌ Mauvais
    if (n < 0)
...
<CardGroup cols={2}>
  <Card title="man stdarg" icon="book">
    ```bash
    man 3 stdarg
    ```
    Documentation des fonctions variadiques
  </Card>
  
  <Card title="man printf" icon="book">
    ```bash
    man 3 printf
    ```
    Comportement de printf original
  </Card>
  
  <Card title="Variadic Functions" icon="code" href="https://www.cprogramming.com/tutorial/c/lesson17.html">
    Tutoriel complet sur les fonctions variadiques
  </Card>
  
  <Card title="printf implementation" icon="github" href="https://github.com/coreutils/coreutils/blob/master/src/printf.c">
    Code source de printf (GNU)
  </Card>
</CardGroup>
